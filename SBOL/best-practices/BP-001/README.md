...
![diagram_abstractions](images/bp_055_diagram_abstractions.png "Common visual abstractions in UML diagrams")
...
![composite_part](images/bp_055_composite_part_example_1.png "Composite part example UML diagram with Locations")
...
![backbone_1](images/bp_055_backbone_example_1.png "Backbone example UML diagram with flanking sequences and Locations")
...
![backbone_2](images/bp_055_backbone_example_2.png "Backbone example UML diagram with flanking sequences and Constraints")
...
![part_in_backbone_1](images/bp_055_part_in_backbone_example_1.png "Part in backbone example UML diagram with flanking sequences in backbone and Locations")
...
![part_in_backbone_2](images/bp_055_part_in_backbone_example_2.png "Part in backbone example UML diagram with flanking sequences in backbone and Constraints")
...
![part_in_backbone_3](images/bp_055_part_in_backbone_example_3.png "Part in backbone example UML diagram with flanking sequences in part insert and Locations")
...
![part_in_backbone_4](images/bp_055_part_in_backbone_example_4.png "Part in backbone example UML diagram with flanking sequences in part insert/extract and Locations")
...
![part_extract_1](images/bp_055_part_extract_example_1.png "Part extract example UML diagram with Locations")

**Figure 10:** Part extract example UML diagram with `Locations`.

![part_extract_2](images/bp_055_part_extract_example_2.png "Part extract example UML diagram with Constraints")
...
![assembly](images/bp_055_assembly_example.png "Assembly example UML diagram with flanking sequences in backbone and Locations")
